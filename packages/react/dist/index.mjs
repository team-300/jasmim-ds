...
var Icon = (_a) => {
  ...
  return /* @__PURE__ */ jsx4("i", __spreadValues({ className }, rest));
};
  ...
  return /* @__PURE__ */ jsxs3(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        ...
        title && /* @__PURE__ */ jsx5("p", { className: "flex-1 text-left", children: title }),
        /* @__PURE__ */ jsx5(
          Icon,
          {
            className: clsx(
...
function Placeholder() {
  return /* @__PURE__ */ jsxs4(
    "svg",
    {
      ...
      viewBox: "0 0 45 44",
      children: [
        /* @__PURE__ */ jsxs4("g", { clipPath: "url(#clip0_1_5)", children: [
          /* @__PURE__ */ jsx6("path", { fill: "#E9EBF0", d: "M0.087 0H44.087V44H0.087z" }),
          /* @__PURE__ */ jsx6(
            "path",
            {
              fill: "#fff",
        ...
        /* @__PURE__ */ jsx6("path", { stroke: "#E9EBF0", d: "M0.587 0.5H43.587V43.5H0.587z" }),
        /* @__PURE__ */ jsx6("defs", { children: /* @__PURE__ */ jsx6("clipPath", { id: "clip0_1_5", children: /* @__PURE__ */ jsx6("path", { fill: "#fff", d: "M0.087 0H44.087V44H0.087z" }) }) })
      ]
    }
  );
}
var AvatarProfile = ({
  ...
  return isLoaded && !!avatarUrl !== false ? /* @__PURE__ */ jsx6(
    "img",
    {
      src: avatarUrl,
      className: clsx2(
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx6("div", { className: "scale-[1.1]", children: /* @__PURE__ */ jsx6(Placeholder, {}) })
    }
  );
};
...
var Button = (_a) => {
  ...
  return /* @__PURE__ */ jsxs6(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        leftIcon && /* @__PURE__ */ jsx8(Icon, { className: `icon-${leftIcon} ${iconSizes[size]}` }),
        ...
        children && /* @__PURE__ */ jsx8("p", { children }),
        rightIcon && /* @__PURE__ */ jsx8(Icon, { className: `icon-${rightIcon} ${iconSizes[size]}` })
      ]
    })
  );
};
...
var Chip = (_a) => {
  ...
  return /* @__PURE__ */ jsxs7(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        title,
        isClosable && isSelected && /* @__PURE__ */ jsx9(Icon, { className: "icon-close-sm text-[24px]" })
      ]
    })
  );
};
...
var LoadingBrand = ({
  ...
  return /* @__PURE__ */ jsxs8("div", { className: "flex flex-col items-center justify-center", children: [
    /* @__PURE__ */ jsxs8("div", { className: "relative flex items-center justify-center", children: [
      ...
      /* @__PURE__ */ jsx11("div", { className: "absolute", children: /* @__PURE__ */ jsx11(Logo, {}) })
    ] }),
    /* @__PURE__ */ jsx11("div", { className: "my-5 text-body-2-medium text-gray-7", children: text })
  ] });
};
...
var NavButton = (_a) => {
  ...
  return /* @__PURE__ */ jsxs9(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        kind === "back-full" && /* @__PURE__ */ jsxs9(Fragment, { children: [
          /* @__PURE__ */ jsx12(Icon, { className: "icon-arrow-r rotate-180 text-gray-5 transition-all duration-300 group-hover:text-gray-6 text-[20px]" }),
          "Voltar"
        ] }),
        kind === "back-arrow" && /* @__PURE__ */ jsx12(
          Icon,
          {
        ...
        kind === "back-single" && /* @__PURE__ */ jsx12(
          Icon,
          {
...
var SocialButton = (_a) => {
  ...
  return /* @__PURE__ */ jsxs10(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        variation === "google" ? /* @__PURE__ */ jsx13(IconGoogle, { width: 24, height: 24 }) : /* @__PURE__ */ jsx13(IconFacebook, { width: 24, height: 24 }),
        children && /* @__PURE__ */ jsx13("span", { className: "flex-1 text-body-2-medium text-gray-8", children })
      ]
    })
  );
};
  ...
  return /* @__PURE__ */ jsxs11(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx14("span", { className: "pl-2 font-work-sans text-body-3-regular text-gray-8", children: title })
      ]
    }
  );
};
...
var StepperBar = ({
  ...
  return /* @__PURE__ */ jsx15("ul", { className: "flex items-center gap-3", children: steps.map((step, index) => /* @__PURE__ */ jsxs12(
    "li",
    {
      ...
      children: [
        /* @__PURE__ */ jsx15(
          "span",
          {
            ...
            children: currentStepBar > index + 1 ? /* @__PURE__ */ jsx15(Icon, { className: "icon-check text-white text-[24px]" }) : index + 1
          }
        ),
        /* @__PURE__ */ jsx15(
          "span",
...
var ToggleSwitch = ({
  ...
  return /* @__PURE__ */ jsxs13(
    "div",
    {
      ...
      children: [
        labelDir === "left" && /* @__PURE__ */ jsxs13("div", { children: [
          /* @__PURE__ */ jsx16(
            "p",
            {
              className: clsx9(
        ...
        /* @__PURE__ */ jsx16(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx16("div", { className: "h-[18px] w-[18px] rounded-full bg-white" })
          }
        ),
        labelDir === "right" && /* @__PURE__ */ jsx16("div", { children: /* @__PURE__ */ jsx16(
          "p",
          {
            className: clsx9(
              "text-body-3-regular ",
